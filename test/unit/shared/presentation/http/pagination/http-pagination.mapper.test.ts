...
describe('HttpPaginationMapper', () => {
  ...
  describe('toPagination', () => {
    it('should build pagination metadata when previous and next pages exist', () => {
      expect(httpPaginationMapper.toPagination(50, 10, 10, 3, '/jobs')).toEqual(
        {
          totalItems: 50,
          itemCount: 10,
          itemsPerPage: 10,
    ...
    it('should build pagination metadata for the first and last page boundaries', () => {
      expect(httpPaginationMapper.toPagination(10, 10, 10, 1, '/jobs')).toEqual(
        {
          totalItems: 10,
          itemCount: 10,
          itemsPerPage: 10,
