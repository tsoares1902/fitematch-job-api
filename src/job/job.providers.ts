...
import { LIST_JOB_REPOSITORY } from '@src/job/applications/contracts/list-job.repository-interface';
import { LIST_JOB_USE_CASE } from '@src/job/applications/contracts/list-job.use-case-interface';
